/***************************************************************************
                           CPhysicsListBase1.cc  -  description
                             -------------------
    begin                : 2001-2009
    copyright            : (C) 2008 R Nartallo, modified by Andrea Bulgarelli, V. Fioretti
...
CPhysicsListBase1::CPhysicsListBase1():  G4VUserPhysicsList() {
    // Default cut values
...
CPhysicsListBase1::~CPhysicsListBase1() {}

void CPhysicsListBase1::ConstructParticle() {
...
void CPhysicsListBase1::ConstructBosons() {
    // pseudo-particles
...
void CPhysicsListBase1::ConstructLeptons() {
    // leptons
...
void CPhysicsListBase1::ConstructMesons() {
...
void CPhysicsListBase1::ConstructBaryons() {
    //  barions
...
void CPhysicsListBase1::ConstructAllShortLiveds() {}

void CPhysicsListBase1::ConstructProcess() {
 ...
 *
 */
void CPhysicsListBase1::ConstructEM() {
    ...
    while( (*theParticleIterator)() ) {
        ...
        if (particleName == "gamma") {
            ...
            //all others charged particles except geantino and proton
...
void CPhysicsListBase1::ConstructGeneral() {
...
void CPhysicsListBase1::SetCuts() {
    // defaultCutValue you have typed in is used

    if (verboseLevel >1) {
        G4cout << "CPhysicsListBase1::SetCuts:" << G4endl;
    }
...
void CPhysicsListBase1::SetCutForGamma(G4double cut) {
    ResetCuts();
    cutForGamma = cut;
}

void CPhysicsListBase1::SetCutForElectron(G4double cut) {
    ResetCuts();
    cutForElectron = cut;
}

void CPhysicsListBase1::SetCutForPositron(G4double cut) {
    cutForPositron = cut;
}


G4double CPhysicsListBase1::GetCutForGamma() const {
    return cutForGamma;
}

G4double CPhysicsListBase1::GetCutForElectron() const {
    return cutForElectron;
}

G4double CPhysicsListBase1::GetCutForPositron() const {
    return cutForPositron;
}


/*
void CPhysicsListBase1::SetCollimator_cuts(G4double cut)
{
...
void CPhysicsListBase1::SetDetector_cuts(G4double cut)
{
...
void CPhysicsListBase1::SetPlattform_cuts(G4double cut)
{
