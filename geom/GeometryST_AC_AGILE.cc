...
GeometryST_AC_AGILE::GeometryST_AC_AGILE() {
...
G4VPhysicalVolume* GeometryST_AC_AGILE::Construct() {
    ...
    G4cout << "##################################" << G4endl;
    G4cout << "AGILE AC construct" << G4endl;
    G4cout << "##################################" << G4endl;
...
void  GeometryST_AC_AGILE::SetPhysicalWorld(G4VPhysicalVolume* World_phys) {
    this->World_phys = World_phys;
    this->World_log = World_phys->GetLogicalVolume();
}

G4VPhysicalVolume* GeometryST_AC_AGILE::ConstructGeometry(G4VPhysicalVolume* World_phys) {
    ...
    //gm.config->readInto(ACDistMinusX, "GEOM.ST.AC.DISTANCE.MINUSX");
    //G4cout << "GEOM.ST.AC.DISTANCE.MINUSX: " << ACDist << G4endl;
    //gm.config->readInto(ACDistMinusY, "GEOM.ST.AC.DISTANCE.MINUSY");
    //G4cout << "GEOM.ST.AC.DISTANCE.MINUSY: " << ACDist << G4endl;
    //gm.config->readInto(ACTopFromLatDist, "GEOM.ST.AC.TOPFROMLAT.DISTANCE");
    //G4cout << "GEOM.ST.AC.TOPFROMLAT.DISTANCE: " << ACTopFromLatDist << G4endl;
    ...
    // Lateral AC  +X
    G4ThreeVector ACLat_pos1plusX(+((Elec_tot_side + ACLat_t)/2.0 + ACDist), -((Elec_tot_side)/2.0 + ACDist + ACLat_extra - ACLat_side/2.0), +(Trk_Zstart + Trk_h + ACDist - (ACLat_h/2.0)));
    ACLatX_phys = new G4PVPlacement(0, ACLat_pos1plusX, ACLatX_log, "pACLatX", World_log, false,311);
    G4ThreeVector ACLat_pos2plusX(+((Elec_tot_side + ACLat_t)/2.0 + ACDist), -((Elec_tot_side)/2.0 + ACDist + ACLat_extra - ACLat_side - ACLat_side/2.0), +(Trk_Zstart + Trk_h + ACDist - (ACLat_h/2.0)));
    ACLatX_phys = new G4PVPlacement(0, ACLat_pos2plusX, ACLatX_log, "pACLatX", World_log, false,312);
    G4ThreeVector ACLat_pos3plusX(+((Elec_tot_side + ACLat_t)/2.0 + ACDist), -((Elec_tot_side)/2.0 + ACDist + ACLat_extra - (2.0*ACLat_side) - ACLat_side/2.0), +(Trk_Zstart + Trk_h + ACDist - (ACLat_h/2.0)));
    ACLatX_phys = new G4PVPlacement(0, ACLat_pos3plusX, ACLatX_log, "pACLatX", World_log, false,313);
    ...
    // Lateral AC  -Y
    G4ThreeVector ACLat_pos1minY(-((Elec_tot_side)/2.0 + ACDist - ACLat_side/2.0 + ACLat_extra), -((Elec_tot_side + ACLat_t)/2.0 + ACDist), +(Trk_Zstart + Trk_h + ACDist - (ACLat_h/2.0)));
    ACLatY_phys = new G4PVPlacement(0, ACLat_pos1minY, ACLatY_log, "pACLatY", World_log, false,321);
    G4ThreeVector ACLat_pos2minY(-((Elec_tot_side)/2.0 + ACDist - ACLat_side - ACLat_side/2.0 + ACLat_extra), -((Elec_tot_side + ACLat_t)/2.0 + ACDist), +(Trk_Zstart + Trk_h + ACDist - (ACLat_h/2.0)));
    ACLatY_phys = new G4PVPlacement(0, ACLat_pos2minY, ACLatY_log, "pACLatY", World_log, false,322);
    G4ThreeVector ACLat_pos3minY(-((Elec_tot_side)/2.0 + ACDist - (2.0*ACLat_side) - ACLat_side/2.0 + ACLat_extra), -((Elec_tot_side + ACLat_t)/2.0 + ACDist), +(Trk_Zstart + Trk_h + ACDist - (ACLat_h/2.0)));
    ACLatY_phys = new G4PVPlacement(0, ACLat_pos3minY, ACLatY_log, "pACLatY", World_log, false,323);
    ...
    ACLatY_phys = new G4PVPlacement(0, ACLat_pos1plusY, ACLatY_log, "pACLatY", World_log, false,331);
    ...
    ACLatY_phys = new G4PVPlacement(0, ACLat_pos2plusY, ACLatY_log, "pACLatY", World_log, false,332);
    ...
    ACLatY_phys = new G4PVPlacement(0, ACLat_pos3plusY, ACLatY_log, "pACLatY", World_log, false,333);
    ...
    ACTop_phys = new G4PVPlacement(0, ACTop_pos, ACTop_log, "pACTop", World_log, false,340);
    ...
    if (CaseAC != 1) {
        ACBottom_phys = new G4PVPlacement(0, ACBottom_pos, ACBottom_log, "pACBottom", World_log, false,350);
        if (SensAC) {
