...
// ********************************************************************
//
// $Id: based on B2ActionInitialization.cc 68058 2013-03-13 14:47:43Z gcosmo $
//
...
{
  SetUserAction(new CPrimaryGeneratorAction);
  //SetUserAction(new CRunAction);
  SetUserAction(new CEventAction);
  SetUserAction(new CSteppingAction);
}  
