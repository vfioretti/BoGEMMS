...
#ifndef RdBProtoPhys_h
#define RdBProtoPhys_h 1
...
class RdBProtoPhys: public G4VModularPhysicsList
{
public:
    
    RdBProtoPhys();
    virtual ~RdBProtoPhys();
...
private:
    ...
    G4VPhysicsConstructor*  emRdBProtoPhys;
    G4VPhysicsConstructor*  decRdBProtoPhys;
    G4VPhysicsConstructor*  raddecRdBProtoPhys;
    std::vector<G4VPhysicsConstructor*>  hadronRdBProtoPhys;
