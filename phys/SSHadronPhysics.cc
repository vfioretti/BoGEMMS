...
SSHadronPhysics::SSHadronPhysics(const G4String& name)
    :G4VPhysicsConstructor(name)
{
    ;
}

SSHadronPhysics::~SSHadronPhysics()
{
    ;
}


void SSHadronPhysics::ConstructParticle()
{
...
void SSHadronPhysics::ConstructProcess()
{
    ...
    G4BGGNucleonInelasticXS* proton_XC =
